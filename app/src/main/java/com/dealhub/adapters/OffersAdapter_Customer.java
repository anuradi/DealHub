...
public class OffersAdapter_Customer extends RecyclerView.Adapter<OffersAdapter_Customer.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue()==null){
                    ...
                    holder.like.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            FirebaseDatabase.getInstance().getReference().child("Likes").child(firebaseUser.getUid()).child("Following").child(ofr.getShopname()).setValue(true);
                    ...
                    holder.like.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            FirebaseDatabase.getInstance().getReference().child("Likes").child(firebaseUser.getUid()).child("Following").child(ofr.getShopname()).setValue(null);
                            holder.like.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.like_gray));
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        holder.save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                DatabaseReference following = FirebaseDatabase.getInstance().getReference().child("Favourites").child(firebaseUser.getUid()).child("Following").child(ofr.getShopname());
                following.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.getValue()==null){
                            ...
                            holder.save.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    FirebaseDatabase.getInstance().getReference().child("Favourites").child(firebaseUser.getUid()).child("Following").child(ofr.getShopname()).setValue(true);
                            ...
                            holder.save.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    FirebaseDatabase.getInstance().getReference().child("Favourites").child(firebaseUser.getUid()).child("Following").child(ofr.getShopname()).setValue(null);
                                    holder.save.setImageDrawable(ContextCompat.getDrawable(context,R.drawable.star_favorite_gray));
                                }
                            });
                        }
